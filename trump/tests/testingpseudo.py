...
# for every database platform that we choose to support... [Postgresql,
# SQLite,... ]

# if that database is available on this system AND the config file
# contains settings for it
